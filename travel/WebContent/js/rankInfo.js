...
searchItemRenderers = {
    ...
    webPages: function(item) {
        var html = [];
        html.push("<p class='webPages' style='margin:50px;'><a href='" + item.url + "' target='_blank' style='font-size:25px;font-weight: bold;'>" + item.name + "</a>");
    ...
    images: function(item, section, index, count) {
        ...
        html.push("<a href='" + item.hostPageUrl + "' target='_blank'>");
