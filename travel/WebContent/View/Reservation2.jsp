...
<div class="font content" style="max-width:auto; margin-left:210px; margin-top:0px; margin-bottom:70px; ">
<BR>
 <table class="bor tablesun" style="background-color: #EFEFFF; opacity: 0.7;" > 	
 	<tr>
 		<td colspan="12" width="1200px" class="bor-bot" style="padding-top:20px;" >출발지 : ${from} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 도착지 : ${to}</td><!-- </td><td colspan="2" width="500px" style="padding-top:20px;"></td> -->
 	</tr>
 	<tr>
 		<td colspan="4" style="padding-top:20px; padding-left:20px; padding-right:20px;">출발날짜 : ${fromdate}<br>항공기번호 : ${al}</td><td colspan="1" style="padding-top:20px;">성인 : ${num}명, 좌석 : ${seat}<br>가격 : ${price}</td> <td colspan="1" style="padding-top:20px;">총금액 : ${TotalPrice}</td>
 	</tr>
   	<tr>
   		<td colspan="4" style="padding-top:20px;">항공사 : ${ac}</td> <td style="padding-top:20px; padding-right:20px; padding-left:20px;">출발시간 : ${fromdate}/${dt}</td><td style="padding-top:20px; padding-right:20px; padding-left:20px;">도착시간 : ${fromdate}/${at}</td> <!-- todate 오는날짜-->
   	</tr>    
  </table>
</div> 
<div style="max-width:auto; margin-top:50px; margin-left:210px; ">
	<form class="font tr td content" action="./AirportPayment.al" onsubmit="return check()" >  
  		<table class="tablesun" border="2px solid red" style="padding-bottom:50px; background-color: #EFEFEF; opacity: 0.8;">  	
 			<tr><td width="680x"><br>Last Name (성)</td><td width="680px"><br>First Name (이름)</td><td width="165px"><br>국적</td></tr>
 			<tr><td style="padding-top:20px; padding-bottom:20px; padding-left:20px;" ><input type="text" placeholder="예:HONG" name="성" maxlength="10"></td>
 				<td><input type="text" placeholder="예:GILDONG" name="이름" maxlength="30"></td>
 				<td style="padding-right:20px;"><select style="width: 120px; height: 67px;" name="contury" >
   			...
   			<tr><td colspan="1">Phone (휴대전화)</td><td colspan="1">Email (이메일)</td><td></td></tr>
 			<tr><td style="padding-top:20px; padding-bottom:20px; padding-left:20px;"><input type="text" placeholder="예:010-1234-5678" name="휴대전화" value="${dto.phone}"></td>
 				<td colspan="1"><input type="text" placeholder="예:gildong@naver.com" name="이메일" value="${dto.email}"><td></td></td>
 			</tr> 
    		<tr><td colspan="3" align="right" ><button type="submit" class="button button3" style ="width: 200px; margin-right: 20px; margin-bottom: 20px;">예약</button></td></tr>
  		</table>
  		<input type="hidden" name="구매자주소" value="${dto.address}">
  		...
  		<input type="hidden" name="출발시간" value="${fromdate}/${dt}">
