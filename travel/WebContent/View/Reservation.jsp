...
<script src="<%=request.getContextPath()%>/js/ReservationCheck.js"
...
<body>
	<c:if test="${check==1}">
		...
		location.href="<%=request.getContextPath()%>/airportList.jsp";
		</script>
	</c:if>
	...
	<div class="img">
		<div class="w3-bar w3-white w3-border-bottom w3-xlarge topvar"
			style="opacity: 0.7;">
			<a href="<%=request.getContextPath()%>/main.jsp"
				class="w3-bar-item w3-button w3-text-red w3-hover-red"><b><i
					class="fa fa-map-marker w3-margin-right"></i>Yolo-Travel</b></a>
			<button class="w3-bar-item w3-button w3-text-red w3-hover-red"
				style="margin-top: 0px;"
				onclick="document.getElementById('id01').style.display='block'">Login</button>
			<button
				class="w3-bar-item w3-button w3-text-red w3-hover-red w3-right"
				style="margin-top: 0px;"
				onclick="document.getElementById('id02').style.display='block'">Subscribe</button>
			<button
				class="w3-bar-item w3-button w3-text-red w3-hover-red w3-right"
				style="margin-top: 0px;"
				onclick="document.getElementById('id03').style.display='block'">Contact</button>
		</div>
			...
			<table class="bor tablesun"
				...
				<tr>
					<td colspan="12" width="1200px" class="bor-bot"
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 도착지 : ${to}</td>
					<!-- </td><td colspan="2" width="500px" style="padding-top:20px;"></td> -->
				</tr>
				<tr>
					<td colspan="4"
